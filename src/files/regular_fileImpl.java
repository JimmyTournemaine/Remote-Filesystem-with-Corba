...
public class regular_fileImpl extends files.regular_filePOA {
	...
	/**
	 * Read {@code size} characters in the file from {@code offset}.
	 * The file must has been opened in read_only or read_write mode.
	 * 
	...
	/**
	 * Write {@code size} characters of the given data in the file from the offset.
	 * The file must has been opened with a write access.
	 * In write_append mode, the offset is always put at the end of the file.
	 * 
	 ...
	 */
	@Override
	public void seek(int new_offset) throws files.invalid_offset, files.invalid_operation, files.io {
